...
class GantView @JvmOverloads constructor(
    ...
    // Цвета градиента
    private val gradientStartColor = ContextCompat.getColor(context, R.color.purple_700)
    private val gradientEndColor = ContextCompat.getColor(context, R.color.purple_200)
